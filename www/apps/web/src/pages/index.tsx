...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <Link className="p-1 -m-1 group" {...props}>
      <Icon className="w-6 h-6 transition fill-zinc-500 dark:fill-zinc-400 dark:group-hover:fill-zinc-300 group-hover:fill-zinc-600" />
    </Link>
  )
}
...
function Resume() {
  ...
  return (
    <div className="p-6 rounded-2xl border border-zinc-100 dark:border-zinc-700/40">
      ...
      <ol className="mt-6 space-y-4">
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="flex relative flex-none justify-center items-center mt-1 w-10 h-10 rounded-full ring-1 shadow-md dark:border dark:ring-0 shadow-zinc-800/5 ring-zinc-900/5 dark:border-zinc-700/50 dark:bg-zinc-800">
      ...
      <Button href="#" intent="secondary" className="mt-6 w-full group">
        Download CV
  ...
  return (
    <>
      ...
      <Container className="mt-24 md:mt-28">
        <div className="grid grid-cols-1 gap-y-20 mx-auto max-w-xl lg:grid-cols-2 lg:max-w-none">
